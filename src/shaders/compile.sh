# Script from https://github.com/feresr/foster/blob/main/Framework/Content/compile.sh
# To compile shadercross see: https://gist.github.com/trojanfoe/aae4fe796c7bb8a58fd53d6562b4400d
compile() {
	local input=$1
	local stage=$2
	local outdir=$3
